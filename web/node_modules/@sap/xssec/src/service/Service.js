...
const { DEFAULT_JWT_BEARER_FETCH_TIMEOUT, GRANTTYPE_CLIENTCREDENTIALS, GRANTTYPE_JWTBEARER, GRANTTYPE_PASSWORD } = require("../util/constants");
...
class Service {
    ...
    */
    ...
    async fetchJwtBearerToken(assertion, options = {}) {
        ...
        const tokenUrl = await this.getTokenUrl(grant_type, options);
        const request = this.buildTokenRequest(grant_type, options);
        request.timeout ??= DEFAULT_JWT_BEARER_FETCH_TIMEOUT;
